    ...
    .directive('json', ["$compile", function($compile) {
      return {
        ...
        link: function(scope, element, attributes) {
          ...
          // start template
          if (scope.type == "object"){
            var template = '<i ng-click="toggleCollapse()" class="fa" ng-class="chevron"></i>'
                ...
                + 'ng-blur="moveKey(child, key, newkey)"/>'
                  // delete button
                + '<i class="deleteKeyBtn fa fa-trash" ng-click="deleteKey(child, key)"></i>'
                + '</span>'
                  // object value
            ...
            var template = '<i ng-click="toggleCollapse()" class="fa"'
                ...
                + '<li class="arrayItem" ng-repeat="val in child track by $index">'
                  // delete button
                + '<i class="deleteKeyBtn fa fa-trash" ng-click="deleteKey(child, $index)"></i>'
                + '<i class="moveArrayItemBtn fa fa-bars"></i>'
